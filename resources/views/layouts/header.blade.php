...
<header class="main-header fixed-top bg-white">
    <nav class="navbar top-navbar justify-content-between align-items-center navbar-expand-md navbar-light">
         ...
         <div class="d-flex w-50 align-items-center">
             <div class="me-3 trigger-sidenav">
                 <i class="fa-solid fa-xmark f-s-18 cursor-pointer"></i>
                 <i class="fa-solid fa-bars f-s-18 cursor-pointer"></i>
             </div>
                 ...
                 <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                     ...
                     <li><a class="dropdown-item" href="#">Lead</a></li>
                      <li><a class="dropdown-item" href="#">Invoice</a></li>
                       ...
                       <div>
                             <div class="dropdown notifiaction-area">
                               <button type="button" class="notifiaction-btn" >
                    ...
                    <div class="dropdown profile-dropdown">
                        <button class="p-0 d-flex align-items-center" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="me-2">
                                <img class="inline-block h-10 w-10 rounded-full" src={{ asset("img/user-icon.jpg") }} alt="">
                            </div>
                            <div>
                                <h4 class="mb-0 text-left text-xs">Emay Walter<span class="f-s-12 f-w-400 d-block  text-secondary">Admin <i class="fa-solid fa-angle-down f-s-10 p-1"></i></span></h4>
                            </div>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end p-0" aria-labelledby="dropdownMenuButton1">
                            ...
                            <li><a class="dropdown-item p-1" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa-solid fa-power-off"></i>@lang('app.logout')</a></li>
